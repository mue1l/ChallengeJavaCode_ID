...
public class Main {
    public static void main(String[] args) {
        ...
        Sales sls = new Sales("kokoko",LocalDate.of(2025,7,23),
                2000000,50000);

        QA qa1 = new QA("HAHAH", LocalDate.of(2025,6,7),400000, 10000);


        List<Employee> ListEmployee = List.of(empl,empl2, empl3, prog,sls,qa1   );
